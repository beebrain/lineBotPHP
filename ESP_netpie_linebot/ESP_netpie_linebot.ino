...
#define KEY     "CyjMAcrElwMZM53"     //change this to your KEY
#define SECRET  "kA0orrqNFfCV2MEaoCuSxhir0"     //change this to your SECRET

#define ALIAS   "Gate" //set name of drvice
